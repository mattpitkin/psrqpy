...
COORD1_QUERY = r'&coords_1={coords1}'
COORD2_QUERY = r'&coords_2={coords2}'
...
QUERY_URL = ATNF_URL + PARAMS_QUERY + USERDEFINED_QUERY + SORT_QUERY + CONDITION_QUERY + PSRNAMES_QUERY + EPHEMERIS_QUERY + RADIUS+QUERY + COORD1_QUERY + COORD2_QUERY + QUERY_FLUFF
